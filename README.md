...
## 说明
通过近三个月的前端课程学习，结合平时技术积累，完成了最后的大作业并取得了优异的成绩，总算是这段时间的辛苦付出没有白费。这也仅仅是一个开始，前端的路是先平稳后曲折，再前端领域技术更新日新月异的今天，唯有掌握好基础知识，加强独立思考的能力，才不会随波逐流。同时我也把课堂教授的点点滴滴记录下来，供自己和前端爱好者参考，让我们来开启探索之旅吧^_^。
